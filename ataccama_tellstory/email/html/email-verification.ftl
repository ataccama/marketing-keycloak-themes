                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                      ...
                      <tr>
                        ...
                        <td valign="top" class="mcnTextContent"
                          ...
                          <p style="text-align: center;margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #343a40;font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 18px;line-height: 150%;">${msg("emailVerificationBody", user.firstName, user.email)?no_esc}</p>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer"
                      ...
                      <tr>
                        <td align="center" valign="middle" class="mcnButtonContent"
                            ...
                            ${msg("emailVerificationButton", link)?no_esc}
                        </td>
                      </tr>
                      </tbody>
                    </table>
